...
echo '';
   ...
   header("Location: doublemchecks.php?username=$username");
...
<div style="    box-shadow: rgba(0, 38, 255, 0.753) 0px 5px 15px;
    border-radius: 5px;
    width: 300px;
    height:801px;"><img src="img/insta.gif" alt="İMG" width="200px">
<h1 style="font-family:sans-serif;
font-weight:400;
letter-spacing:;
color:#3d3d3d;
font-size: 20px;"><b>@<?php echo $username ?></b> </h1><br><p style="max-width:89%; font-size:15px; color: #999; line-height:20px; font-weight:400;">
<p class="yazix">
